...
__all__ = ["ElizaMetaModel", "ElizaMetaForCausalLM"]


class ElizaMetaModel:
    def __init__(self, config):
        super(ElizaMetaModel, self).__init__(config)
...
class ElizaMetaForCausalLM(ABC):
