...
from ..eliza_arch import ElizaMetaForCausalLM, ElizaMetaModel
...
class ElizaConfig(LlamaConfig):
    model_type = "eliza_llama"


class ElizaLlamaModel(ElizaMetaModel, LlamaModel):
    config_class = ElizaConfig

    def __init__(self, config: LlamaConfig):
        super(ElizaLlamaModel, self).__init__(config)


class ElizaLlamaForCausalLM(LlamaForCausalLM, ElizaMetaForCausalLM):
    config_class = ElizaConfig
    # base_model_prefix = "eliza"

    def __init__(self, config):
        super(LlamaForCausalLM, self).__init__(config)
        self.model = ElizaLlamaModel(config)
...
AutoConfig.register("eliza_llama", ElizaConfig)
AutoModelForCausalLM.register(ElizaConfig, ElizaLlamaForCausalLM)
